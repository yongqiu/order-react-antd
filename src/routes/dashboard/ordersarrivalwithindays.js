...
class ArrivalInDays extends Component {
    static propTypes = {
    ...
    constructor(props, context) {
        ...
        this.requestData = {
            ...
            body: {
                ...
                endDate: parseInt(this.props.location.query.startday) + 1 * 24 * 3600 * 1000 - 1
            },
            url: '/dashboard/queryEtaTotalOrders'
        };
    ...
    componentDidMount() {
        this.requestServer();
        gaPageFilter.gaSetPage( '/dashboard/ordersindays' , 'The orders that will be arrived in 7 Days' );
        ga( 'send' , regularEvent.showDashboardOrderList_arrivedin7days );
    }
    ...
    render() {
        ...
        return (
            <div className='etdOrdersWrap' style={{ height: '100%' }}>
                ...
                <NavBar { ...navbarProps } >
                    <FormattedMessage id='status_eta_arrived' description='Arrival in 7 days' defaultMessage='Arrival in 7 days' />
                </NavBar>
                <Search {...searchData}/>
...
ArrivalInDays.contextTypes = {
    router: function contextType() {
        return React.PropTypes.Object;
    }
};

export default injectIntl(ArrivalInDays);
